...
'''
In decision tree clasification, the features need not be scled, this will help us in 
plotting the exact same tree in the graph.
But the plot we are using will work faster if we scale the featues as it is made with 
a resolutin of 0.01.
So as a trade off we will use feature scaling. 
'''
...
#Fittiing Decision Tree classifier to training data
...
0# Visualising the Test set results
from matplotlib.colors import ListedColormap
